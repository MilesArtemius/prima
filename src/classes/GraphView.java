...
public class GraphView extends LayerUI<VisualScene> {
    HashMap<Character, HashMap<Character, Double>> nodes;
    ArrayList<Character> literals;
    String solvation;

    public GraphView(HashMap<Character, HashMap<Character, Double>> nodes) {
        this.nodes = nodes;
    ...
    public void paint(Graphics g, JComponent c) {
        ...
        g2.setFont(new Font("Century Schoolbook", Font.PLAIN, 12));
    ...
    public void setSolvation(String answer) {
        this.solvation = answer;
    }
